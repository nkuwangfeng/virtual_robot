...
class CheckForObjectsAction(genpy.Message):
  _md5sum = "5a1e458579996b97604068eb497b0f2b"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.bounding_boxes.boundingBoxes)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.bounding_boxes.boundingBoxes:
        _x = val1.Class
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.bounding_boxes.boundingBoxes = []
      for i in range(0, length):
        ...
        self.action_result.result.bounding_boxes.boundingBoxes.append(val1)
      _x = self
      start = end
      end += 12
